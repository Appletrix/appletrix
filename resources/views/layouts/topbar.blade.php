                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                        ...
                        @switch(Session::get('lang'))
                            @case('ru')
                                <img src="{{ URL::asset('/assets/images/flags/russia.svg') }}" class="me-2 rounded"
                                    height="20" alt="Header Language">
                            @break

                            @case('it')
                                <img src="{{ URL::asset('/assets/images/flags/italy.svg') }}" class="me-2 rounded"
                                    height="20" alt="Header Language">
                            @break

                            @case('sp')
                                <img src="{{ URL::asset('/assets/images/flags/spain.svg') }}" class="me-2 rounded"
                                    height="20" alt="Header Language">
                            @break

                            @case('ch')
                                <img src="{{ URL::asset('/assets/images/flags/china.svg') }}" class="me-2 rounded"
                                    height="20" alt="Header Language">
                            @break

                            @case('fr')
                                <img src="{{ URL::asset('/assets/images/flags/french.svg') }}" class="me-2 rounded"
                                    height="20" alt="Header Language">
                            @break

                            @case('gr')
                                <img src="{{ URL::asset('/assets/images/flags/germany.svg') }}" class="me-2 rounded"
                                    height="20" alt="Header Language">
                            @break

                            @default
                                <img src="{{ URL::asset('/assets/images/flags/us.svg') }}" class="me-2 rounded"
                                    height="20" alt="Header Language" height="16">
                        @endswitch
                    </button>
                    ...
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">Usuario
                                    Nome</span>
